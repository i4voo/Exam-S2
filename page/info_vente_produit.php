...
$nomCate = get_nomcate($id_cat);
$nomC = $nomCate['nom_categorie'];
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<h4 class="mb-0">Vente par produit de la catégorie : <?php echo $nomC;?></h4>
<p class="text-muted mb-4">Sélectionnez un produit pour consulter son vendeur :</p>
...
<tr>
    <td>
        <a href="info_vente_membre.php?idProd=<?php echo $i['idProd'];?>" class="fw-bold text-decoration-none text-success"">
            <?php echo $i['nomProd'];?>
        </a>
    </td>
